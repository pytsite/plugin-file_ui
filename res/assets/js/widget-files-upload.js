define(['jquery', 'http-api', 'lang', 'load-image', 'jquery-ui'], function ($, httpApi, lang) {
    return function (widget) {
        ...
        var thumbWidth = widgetEm.data('thumbWidth');
        var thumbHeight = widgetEm.data('thumbHeight');
